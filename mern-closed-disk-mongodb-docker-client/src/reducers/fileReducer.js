...
// определяем файлы из базы данных по конкретному пользователю в текущей папке
export const setFiles = (files) => ({type: SET_FILES, payload: files}); 
//устанавливаем идентификатор текущей папки
